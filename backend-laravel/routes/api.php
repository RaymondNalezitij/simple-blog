...
Route::middleware(['cors', 'auth:sanctum', 'isAdmin'])->get('/admin/category', [App\Http\Controllers\CategoryController::class, 'index']);
Route::middleware(['cors', 'auth:sanctum', 'isAdmin'])->put('/admin/category/{id}', [App\Http\Controllers\CategoryController::class, 'update']);
Route::middleware(['cors', 'auth:sanctum', 'isAdmin'])->delete('/admin/category/{id}', [App\Http\Controllers\CategoryController::class, 'destroy']);
